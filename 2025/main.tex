...
\newcommand{\name}{Hitesh A H} % Your Name
\newcommand{\course}{Software Engineer} % Your Course
\newcommand{\roll}{XXXXXX} % Your Roll No.
\newcommand{\phone}{9037342953} % Your Phone Number
\newcommand{\emaila}{ahhitesh31@gmail.com} % Email 1
\newcommand{\emailb}{ahhitesh31@gmail.com} % Email 2
\newcommand{\github}{hitesh-ah} % Github
% \newcommand{\website}{https://example.com/} % Website
\newcommand{\linkedin}{hiteshah31} % LinkedIn
...
%----------HEADING-----------------
\parbox{2.35cm}{%
\includegraphics[width=2cm,clip]{HITESH_A_H_Passport_Sized_2024.jpg}
}
...
\resumeSubItem{Programming Languages}{: Typescript, Java, Python, SQL}
\resumeSubItem{Technologies}{: Angular, Spring, Node JS, \LaTeX}
...
\resumeSubHeadingListStart
\resumePOR
    {IGNOU} % Certification Name
    {, \href{www.Certification.com}{BLIS : Bachelor of Library and Information Science}} % Issuer
    {May 2023 - December 2024} % Duration
\resumePOR
...
\resumeSubHeadingListStart
    \resumePOR{\href{https://uandi.org.in/volunteer#submenusouth}{LC Lead}, } % Position
    {U\&I Trust, Trivandrum City} %Club,Event
    {AY 2025-26}
    \resumePOR{\href{https://www.marian.ac.in/pages/student_senate}{Sports Secretary}, } % Position
    {Student Senate, Marian Engineering College} %Club,Event
    {AY 2019-20} %Tenure Period
